    ...
    <div align="center">
            <table>
                ...
                <tr>
                    ...
                    <td><input type="text" name="login" placeholder="Enter vallid Login-Id" size="25" value="<%=DataUtility.getStringData(bean.getLogin())%>"></td>
                ...
                <tr>
                    ...
                    <td><input type="text" name="dob" id="udate" readonly="readonly" size="25" placeholder=" dd-MM-yyyy"  value="<%=DataUtility.getDateString(bean.getDob())%>"></td> 
                ...
                <tr>
                    ...
                    <td><input type="password" name="password" placeholder="Password minimum 8 Digit" size="25" value="<%=DataUtility.getStringData(bean.getPassword())%>"></td>
