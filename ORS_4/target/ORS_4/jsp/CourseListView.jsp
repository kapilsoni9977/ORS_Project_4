...
<jsp:useBean id="bean" class="in.co.rays.ors.bean.CourseBean" scope="request" ></jsp:useBean>
  ...
  <form action="<%=ORSView.COURSE_LIST_CTL%>" method="post">
    ...
    //   System.out.println("______________________"+pageNo);
       
                    int pageSize = ServletUtility.getPageSize(request);
  //                  System.out.println("___________________"+pageSize);
                    
                    int index = (pageNo - 1)*pageSize + 1;

                    List list = ServletUtility.getList(request);
//                    System.out.println("___________________"+list.size());
            ...
            <table width="100%" align="center">
                <tr>
                 ...
                 <label> Course Name :</label> 
                 	<%=HTMLUtility.getList("cname", String.valueOf(bean.getName()), courselist) %>
                 <%-- 	<input type="text" name="course" placeholder="Enter Course Name" Size= "25" value="<%=ServletUtility.getParameter("course", request)%>">
				 --%>	&emsp;
